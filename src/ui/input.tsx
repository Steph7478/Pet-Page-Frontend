...
const inputVariants = cva(
  "placeholder-[var(--brown)] rounded-full hover:brightness-125 focus:outline-none focus:bg-transparent transition-colors duration-150 ease-in-out min-w-[150px] px-8 py-4",
  {
    variants: {
      intent: {
        ...
        formulario:
          "text-black border focus:bg-[var(--light-yellow)] bg-[var(--light-yellow)]/50 rounded px-3 py-2",
